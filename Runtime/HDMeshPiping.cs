...
public class HDMeshPiping
{
    ...
    public static void AddTriangleFan(HDMesh mesh, int center, int iStart, int iEnd, bool inverse = false)
    {
    ...
    public static HDMesh PipeLineWithConvexProfile(Vector3 a, Vector3 b, List<Vector3> profile, Vector3 up, bool closeStart, bool closeEnd)
    {
